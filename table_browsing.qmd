...
<p class="lead">This tool provides insights into the usage of repositories to make
ERC-funded research available. The interactive table breaks down usage by the number and percentage of works deposited ("Deposits") and the number and percentage of ERC projects making use of a repository ("Projects"). Figures are presented by repository type and ERC panel.</p>
